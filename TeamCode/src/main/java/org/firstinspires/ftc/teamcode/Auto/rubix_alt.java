...
public class rubix_alt extends LinearOpMode {
    @Override
    public void runOpMode() {
      ...
      //  resetRuntime();
        ...
        TrajectoryActionBuilder spec1 = drive.actionBuilder(initialPose)
                ...
                .afterTime(0.1,arm.SetPosition(-600))
                .splineToLinearHeading(new Pose2d(-8,36, Math.toRadians(270)), Math.toRadians(270))
                .afterTime(0,arm.SetPosition(-800)) //slam spec
                .waitSeconds(0.5)
                .stopAndAdd(arm.openClaw())
                .strafeToLinearHeading(new Vector2d(22,40), Math.toRadians(270))
                .afterTime(0, arm.SetPosition(-175))
                ...
                .afterTime(0.5,arm.SetPosition(-600))
                .stopAndAdd(arm.armUp())
                .strafeToLinearHeading(new Vector2d(-10,34), Math.toRadians(270))
                .afterTime(0.3,arm.SetPosition(-800)) //slam spec
                .waitSeconds(0.5)
                .stopAndAdd(arm.openClaw())
                .afterTime(0, arm.SetPosition(-175))
                .stopAndAdd(arm.armDown())
